...
export function MutasiModal({ isOpen, onClose, onSubmit, products, initialData }: MutasiModalProps) {
    ...
    const footer = (
        <>
            ...
            <AppButton type="submit" form="mutasi-form" variant="primary" disabled={isLoadingMaterials}>Simpan Data</AppButton>
        </>
    );
